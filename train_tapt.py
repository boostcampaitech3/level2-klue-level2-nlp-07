...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="model to train (default: klue/bert-base)",
    )
    parser.add_argument(
        "--train_data",
        type=str,
        default="../dataset/train/train.csv",
        help="train_data directory (default: ../dataset/train/train.csv)",
    )
    parser.add_argument(
        "--num_labels", type=int, default=30, help="number of labels (default: 30)"
    )
    parser.add_argument(
        "--output_dir",
        type=str,
        default="./results",
        help="directory which stores various outputs (default: ./results)",
    )
    parser.add_argument(
        "--save_total_limit",
        type=int,
        default=5,
        help="max number of saved models (default: 5)",
    )
    parser.add_argument(
        "--save_steps",
        type=int,
        default=500,
        help="interval of saving model (default: 500)",
    )
    parser.add_argument(
        "--num_train_epochs",
        type=int,
        default=20,
        help="number of train epochs (default: 20)",
    )
    parser.add_argument(
        "--learning_rate",
        type=float,
    ...
    parser.add_argument(
        "--per_device_train_batch_size", type=int, default=16, help=" (default: 16)"
    )
    parser.add_argument(
        "--per_device_eval_batch_size", type=int, default=16, help=" (default: 16)"
    )
    parser.add_argument("--warmup_steps", type=int, default=500, help=" (default: 500)")
    parser.add_argument(
        "--weight_decay", type=float, default=0.01, help=" (default: 0.01)"
    )
    parser.add_argument(
        "--logging_dir", type=str, default="./logs", help=" (default: ./logs)"
    )
    parser.add_argument(
        "--logging_steps", type=int, default=100, help=" (default: 100)"
    )
    parser.add_argument(
        "--evaluation_strategy", type=str, default="steps", help=" (default: steps)"
    )
    parser.add_argument("--eval_steps", type=int, default=500, help=" (default: 500)")
    parser.add_argument(
        "--load_best_model_at_end", type=bool, default=True, help=" (default: True)"
    )
    parser.add_argument(
        "--save_pretrained",
        type=str,
        default="./best_model",
        help=" (default: ./best_model)",
    )
    ...
    parser.add_argument(
        "--project_name", type=str, default="Model_Test", help=" (default: )"
    )
    parser.add_argument(
        "--entity_name", type=str, default="growing_sesame", help=" (default: )"
    )
